...
config.General.workArea = 'crab_projects_P2TP_AllQ_Sep16/'

config.section_('JobType')
config.JobType.psetName = '../L1Trigger/L1TMuonOverlapPhase2/test/runMuonOverlap_SF_allQ.py'
config.JobType.pluginName = 'Analysis'
config.JobType.outputFiles = ["l1tomtf_superprimitives2.root"]
config.JobType.allowUndistributedCMSSW = True

config.section_('Data')
config.Data.splitting = 'FileBased'
config.JobType.maxMemoryMB = 2500
config.Data.outLFNDirBase = '/store/user/folguera/OMTF/20Sep16/P2TP_allQ/'
