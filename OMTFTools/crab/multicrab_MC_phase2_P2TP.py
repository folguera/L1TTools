...
config.General.workArea = 'crab_projects_P2TP_Sep16/'

config.section_('JobType')
config.JobType.psetName = '../L1Trigger/L1TMuonOverlapPhase2/test/runMuonOverlap_SF.py'
...
config.Data.outLFNDirBase = '/store/user/folguera/OMTF/20Sep16/P2TP/'
